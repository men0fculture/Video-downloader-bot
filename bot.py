...
# ---------- Video Download with Cookies and Metadata (720p) ----------
def download_video(url):
    ydl_opts = {
        'format': 'best[height<=720]/best',  # ✅ 720p priority, fallback to best
...
async def handle_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status = await update.message.reply_text("⏳ Downloading video in 720p...")
...
def main():
    ...
    print("🤖 720p Video Bot with Cookies & Captions is running...")
    app.run_polling()
